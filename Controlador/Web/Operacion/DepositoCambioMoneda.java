...
/**
 * Servlet implementation class DepositoCambioMoneda
 */
@WebServlet("/DepositoCambioMoneda")
public class DepositoCambioMoneda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DepositoCambioMoneda() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			String titulo = "Confirmacion Deposito Dolares";
			String numeroCuenta = request.getParameter("numeroCuenta");
			int monto = Integer.parseInt(request.getParameter("monto"));

			String res = Controlador.Consola.Operaciones.depositoCambioMoneda(numeroCuenta, monto);
