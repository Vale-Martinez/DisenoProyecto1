 ...
 */
@WebServlet("/SaldoActualDolares")
public class SaldoActualDolares extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SaldoActualDolares() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//llamar a los metodos en los controlador consola
				String titulo="Saldo Actual en Dolares";
				String numeroCuenta = request.getParameter("numeroCuenta");
				String pin = request.getParameter("Pin");
				String res = Controlador.Consola.Consultas.consultaSaldoActualCambioMoneda(numeroCuenta,pin);
