...
/**
 * Servlet implementation class EstatusCuenta
 */
@WebServlet("/EstatusCuenta")
public class EstatusCuenta extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//llamar a los metodos en los controlador consola
				String titulo="Estatus Cuenta";
				String numeroCuenta = request.getParameter("numeroCuenta");
				

				String res = Controlador.Consola.Consultas.consultaEstatusActual(numeroCuenta);
