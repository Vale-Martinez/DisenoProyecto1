...
/**
 * Servlet implementation class EstadoCuentaColones
 */
@WebServlet("/EstadoCuentaColones")
public class EstadoCuentaColones extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EstadoCuentaColones() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String titulo = "Estado de Cuenta en Colones";
		...
		String res = Controlador.Consola.Consultas.consultarEstadoCuentaColonesWeb(numeroCuenta, pin);
		...
		out.println("</tr>");
		out.println("<tr>");
		Vector clientes = Controlador.Consola.Consultas.consultarDatosEstadoCuentaOperaciones(Atenticacion.Encriptacion.CesarCifradoabc(numeroCuenta));
