 ...
 */
@WebServlet("/ConsultarClienteEspecifico")
public class ConsultarClienteEspecifico extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ConsultarClienteEspecifico() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String titulo = "Cliente Consultado:";
		int identificacion = Integer.parseInt(request.getParameter("identificacion"));

		String res = Controlador.Consola.Consultas.datosClienteEspecificos(identificacion);
